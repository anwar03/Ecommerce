...
class Country(models.Model):
    ...
    country_code2 = models.CharField(verbose_name=_('country code'), max_length=2, null=True, blank=True)
    dialing_code = models.CharField(verbose_name=_('dialing code'), max_length=5, null=True, blank=True)
